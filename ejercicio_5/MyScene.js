...
class MyScene extends THREE.Scene {
  constructor (myCanvas) {
    ...
    this.taza = new MyBSP(this.gui, "Controles de la Taza", 0);
    this.tuerca = new MyBSP(this.gui, "Controles de la Tuerca", 1);
    this.nodoTaza.add(this.taza);
    this.nodoTuerca.add(this.tuerca);
    this.nodoTaza.translateX(-1);
    this.nodoTuerca.translateX(1);
